...
$lang['writemsg'] = array (
	...
	'change_type_title'		=> '您的文章被修改了主题类型',
	'change_type_content'	=> '您发表的文章主题被 [b]{$L[other][manager]}[/b] [b]修改了主题类型为：{$L[other][type]}[/b]'.$lang['_othermsg'],
