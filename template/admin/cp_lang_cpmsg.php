...
'credit_error'				=> '无效积分ID',
'login_error'				=> '密码或安全问题错误,您还可以尝试{$GLOBALS[L_left]}次',
'login_fail'				=> '已经连续 $GLOBALS[F_count] 次进行无效登录,您将在 20 分钟内无法正常登陆后台<br>还剩余 $GLOBALS[L_T] 秒',
...
'attach_renew'				=> '附件修复完成,共{$GLOBALS[count]}处附件被修复',
...
'session_error'				=> '登录后台失败, 请先登陆服务器设置 data/bbscache 目录属性为可写(777模式)',
'htm_error'					=> '分类：“{$GLOBALS[f_name]}” 没有启用静态模版功能，请先启用',
'atc_error'					=> '主题或内容为空',
...
'bbs_open'					=> '由于数据操作较大，请先关闭论坛后，继续操作，'
								. '<a href=$GLOBALS[admin_file]?adminjob=settings&type=bbsset target=blank style="color:blue">进入“核心-常规设置”</a>！',
...
'gusetdir_not_exists'		=> '游客缓存目录不存在，请到“核心-页面缓存”里进行设置!',
...
'settings_adminfile_dfnotfind'	=> '找不到默认后台登陆文件，请下载升级包，上传“admin.php”文件到论坛根目录。',
...
//7.5RC end
'topic_name'					=> '主题标题不能为空或大小不能超过14字节',
'model_not_none'				=> '必须启用一个或一个以上',
'illegal_cateid_or_modelid'		=> '分类信息或者主题模版不存在',
