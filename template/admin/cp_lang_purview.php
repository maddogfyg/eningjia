...
$purview = array(
	...
	'credit'		=> array('内置积分设置',"$admin_file?adminjob=settings&admintype=credit"),
	'creditdiy'		=> array('自定义积分设置',"$admin_file?adminjob=creditdiy"),
	'creditchange'	=> array('积分转换设置',"$admin_file?adminjob=creditchange"),
	...
	'thread'		=> array('主题列表细节设置',"$admin_file?adminjob=settings&admintype=thread"),
	'read'			=> array('帖子阅读页面细节设置',"$admin_file?adminjob=settings&admintype=read"),
	'jsinvoke'		=> array('JS调用设置',"$admin_file?adminjob=settings&admintype=jsinvoke"),
	'popinfo'		=> array('重要页面弹出信息设置',"$admin_file?adminjob=settings&admintype=popinfo"),
	...
	'singleright'	=> array('版块用户特殊权限',"$admin_file?adminjob=singleright"),
	...
	'setbwd'		=> array('词语(过滤)黑名单',"$admin_file?adminjob=setbwd"),
	...
	'customcredit'	=> array('会员自定义积分',"$admin_file?adminjob=customcredit"),
	...
	'rebang'		=> array('首页热门多栏展现',"$admin_file?adminjob=rebang"),
	...
	'area_edittpl'	=> array('本站模版管理',"$admin_file?adminjob=mode&admintype=area_edittpl"),
	...
	'app'			=> array('APP应用',"$admin_file?adminjob=app&action=app&job=appslist"),
