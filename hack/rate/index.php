...
class RateIndex {
    ...
    function _language($key) {
        ...
        $message['rate_anonmity_limit'] = '抱歉，游客评价次数达到上限，请先 <a href="login.php" class="s3">登陆</a>';
    ...
    function _getTypeParams($typeId){
        $links = $titles = array();
        $links['1'] = 'mode.php?m=o&q=hot&action=threadHot&sub=threadRate';
        $links['2'] = 'mode.php?m=o&q=hot&action=diaryHot&sub=diaryRate';
        $links['3'] = 'mode.php?m=o&q=hot&action=picHot&sub=picRate';
        $titles['1'] = '贴子';
        $titles['2'] = '日志';
        $titles['3'] = '照片';
    ...
    function _getReteConfigFilePath($typeId) {
        return R_P . '/data/bbscache/rate_week_' . $typeId . '.php';
    }
