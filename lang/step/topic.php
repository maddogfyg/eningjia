...
foreach ($topicdata as $cate) {
	...
	foreach ($models as $model) {
		...
		$fieldsql = 'tid mediumint(8) unsigned NOT NULL,fid smallint(6) unsigned NOT NULL';
		...
		foreach ($fields as $field) {
			...
			$db->update("REPLACE INTO pw_topicfield SET ".pwSqlSingle($field));
		...
		$db->query('CREATE TABLE '.$tablename.' ('.$fieldsql.($indexsql ? ','.$indexsql : '').") TYPE=MyISAM");
	}
}
